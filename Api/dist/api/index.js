...
const profile_route_1 = require("../src/route/profile-route");
const bank_card_route_1 = require("../src/route/bank-card-route");
const donation_route_1 = require("../src/route/donation-route");
(0, dotenv_1.config)();
